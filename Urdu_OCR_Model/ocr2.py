...
file = open("C:\\Users\\Ashrafi\\Desktop\\Rashid_Urdu_OCR\\Project-Saadhna-Urdu-OCR-Model\\Urdu_OCR_Model\\UrduGlyphs.txt","r",encoding="utf-8")
...
recognition_model.load_state_dict(torch.load("C:\\Users\\Ashrafi\\Desktop\\Rashid_Urdu_OCR\\Project-Saadhna-Urdu-OCR-Model\\Urdu_OCR_Model\\best_norm_ED.pth", map_location=device))
recognition_model.eval()

detection_model = YOLO("C:\\Users\\Ashrafi\\Desktop\\Rashid_Urdu_OCR\\Project-Saadhna-Urdu-OCR-Model\\Urdu_OCR_Model\\yolov8m_UrduDoc.pt")


# Define directories
books_folder = 'C:\\Users\\Ashrafi\\Desktop\\Rashid_Urdu_OCR\\Project-Saadhna-Urdu-OCR-Model\\Urdu_OCR_Model\\books'
pngs_root_folder = 'C:\\Users\\Ashrafi\\Desktop\\Rashid_Urdu_OCR\\Project-Saadhna-Urdu-OCR-Model\\Urdu_OCR_Model\\pdf_images'
text_root_folder = 'C:\\Users\\Ashrafi\\Desktop\\Rashid_Urdu_OCR\\Project-Saadhna-Urdu-OCR-Model\\Urdu_OCR_Model\\extracted_texts'
...
def process_pdf(pdf_file_path):
    ...
    images = convert_from_path(pdf_file_path, dpi=200, output_folder=book_images_folder, fmt='png', paths_only=True)
